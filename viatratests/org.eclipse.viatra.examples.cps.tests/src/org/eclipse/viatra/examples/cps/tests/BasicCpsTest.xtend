...
class BasicCpsTest {
	...
	@Test def void testApplicationTypes() { ViatraQueryTest.test("org.eclipse.viatra.examples.cps.tests.queries.applicationTypes").with(snapshot).with(new ReteBackendFactory).with(LocalSearchBackendFactory.INSTANCE).assertEquals }
	@Test def void testApplicationInstances() { ViatraQueryTest.test("org.eclipse.viatra.examples.cps.tests.queries.applicationInstances").with(snapshot).with(new ReteBackendFactory).with(LocalSearchBackendFactory.INSTANCE).assertEquals }
	@Test def void testApplicationInstancesOfApplicationType() { ViatraQueryTest.test("org.eclipse.viatra.examples.cps.tests.queries.applicationInstancesOfApplicationType").with(snapshot).with(new ReteBackendFactory).with(LocalSearchBackendFactory.INSTANCE).assertEquals }
	@Test def void testApplicationInstancesOfApplicationTypeIdentifiers() { ViatraQueryTest.test("org.eclipse.viatra.examples.cps.tests.queries.applicationInstancesOfApplicationTypeIdentifiers").with(snapshot).with(new ReteBackendFactory).with(LocalSearchBackendFactory.INSTANCE).assertEquals }
	@Test def void testApplicationTypeWithHostedInstances() { ViatraQueryTest.test("org.eclipse.viatra.examples.cps.tests.queries.applicationTypeWithHostedInstances").with(snapshot).with(new ReteBackendFactory).with(LocalSearchBackendFactory.INSTANCE).assertEquals }
	@Test def void testApplicationTypeWithHostedInstanceIdentifiers() { ViatraQueryTest.test("org.eclipse.viatra.examples.cps.tests.queries.applicationTypeWithHostedInstanceIdentifiers").with(snapshot).with(new ReteBackendFactory).with(LocalSearchBackendFactory.INSTANCE).assertEquals }
	@Test def void testApplicationTypeWithoutHostedInstance() { ViatraQueryTest.test("org.eclipse.viatra.examples.cps.tests.queries.applicationTypeWithoutHostedInstance").with(snapshot).with(new ReteBackendFactory).with(LocalSearchBackendFactory.INSTANCE).assertEquals }
	@Test def void testApplicationTypeWithoutHostedInstanceIdentifiers() { ViatraQueryTest.test("org.eclipse.viatra.examples.cps.tests.queries.applicationTypeWithoutHostedInstanceIdentifiers").with(snapshot).with(new ReteBackendFactory).with(LocalSearchBackendFactory.INSTANCE).assertEquals }
	@Test def void testTransitionsOfApplicationType() { ViatraQueryTest.test("org.eclipse.viatra.examples.cps.tests.queries.transitionsOfApplicationType").with(snapshot).with(new ReteBackendFactory).with(LocalSearchBackendFactory.INSTANCE).assertEquals }
	@Test def void testTransitionsOfApplicationTypeIdentifiers() { ViatraQueryTest.test("org.eclipse.viatra.examples.cps.tests.queries.transitionsOfApplicationTypeIdentifiers").with(snapshot).with(new ReteBackendFactory).with(LocalSearchBackendFactory.INSTANCE).assertEquals }
	@Test def void testHostInstancesWithZeroTotalRam() { ViatraQueryTest.test("org.eclipse.viatra.examples.cps.tests.queries.hostInstancesWithZeroTotalRam").with(snapshot).with(new ReteBackendFactory).with(LocalSearchBackendFactory.INSTANCE).assertEquals }
	@Test def void testHostInstanceWithAtLeastAsMuchTotalRamAsTotalHdd() { ViatraQueryTest.test("org.eclipse.viatra.examples.cps.tests.queries.hostInstanceWithAtLeastAsMuchTotalRamAsTotalHdd").with(snapshot).with(new ReteBackendFactory).with(LocalSearchBackendFactory.INSTANCE).assertEquals }
	@Test def void testHostInstanceWithPrimeTotalRam() { ViatraQueryTest.test("org.eclipse.viatra.examples.cps.tests.queries.hostInstanceWithPrimeTotalRam").with(snapshot).with(new ReteBackendFactory).with(LocalSearchBackendFactory.INSTANCE).assertEquals }
	// This is necessary because of 490761 bug
	@Test def void testHasMoreHostedApplicationInstances() { ViatraQueryTest.test("org.eclipse.viatra.examples.cps.tests.queries.hasMoreHostedApplicationInstances").with(snapshot).with(new ReteBackendFactory).with(LocalSearchBackendFactory.INSTANCE).assertEquals }
	// This is necessary because of 490761 bug
	@Test def void testHasTheMostHostedApplicationInstances() { ViatraQueryTest.test("org.eclipse.viatra.examples.cps.tests.queries.hasTheMostHostedApplicationInstances").with(snapshot).with(new ReteBackendFactory).with(LocalSearchBackendFactory.INSTANCE).assertEquals }
	@Test def void testCommunicateWith() { ViatraQueryTest.test("org.eclipse.viatra.examples.cps.tests.queries.communicateWith").with(snapshot).with(new ReteBackendFactory).with(LocalSearchBackendFactory.INSTANCE).assertEquals }
	@Test def void testInTheCommunicationChains() { ViatraQueryTest.test("org.eclipse.viatra.examples.cps.tests.queries.inTheCommunicationChains").with(snapshot).with(new ReteBackendFactory).with(LocalSearchBackendFactory.INSTANCE).assertEquals }
	@Test def void testHasMoreCommunicationPartner() { ViatraQueryTest.test("org.eclipse.viatra.examples.cps.tests.queries.hasMoreCommunicationPartner").with(snapshot).with(new ReteBackendFactory).with(LocalSearchBackendFactory.INSTANCE).assertEquals }
	@Test def void testHasTheMostCommunicationPartner() { ViatraQueryTest.test("org.eclipse.viatra.examples.cps.tests.queries.hasTheMostCommunicationPartner").with(snapshot).with(new ReteBackendFactory).with(LocalSearchBackendFactory.INSTANCE).assertEquals }
	@Test def void testHostedApplications() { ViatraQueryTest.test("org.eclipse.viatra.examples.cps.tests.queries.hostedApplications").with(snapshot).with(new ReteBackendFactory).with(LocalSearchBackendFactory.INSTANCE).assertEquals }
	@Test def void testHasMoreHostedApplications() { ViatraQueryTest.test("org.eclipse.viatra.examples.cps.tests.queries.hasMoreHostedApplications").with(snapshot).with(new ReteBackendFactory).with(LocalSearchBackendFactory.INSTANCE).assertEquals }
	@Test def void testHasTheMostHostedApplications() { ViatraQueryTest.test("org.eclipse.viatra.examples.cps.tests.queries.hasTheMostHostedApplications").with(snapshot).with(new ReteBackendFactory).with(LocalSearchBackendFactory.INSTANCE).assertEquals }
	@Test def void testFinalPattern() { ViatraQueryTest.test("org.eclipse.viatra.examples.cps.tests.queries.finalPattern").with(snapshot).with(new ReteBackendFactory).with(LocalSearchBackendFactory.INSTANCE).assertEquals }
	@Test def void testInstances() { ViatraQueryTest.test("org.eclipse.viatra.examples.cps.tests.queries.instances").with(snapshot).with(new ReteBackendFactory).with(LocalSearchBackendFactory.INSTANCE).assertEquals }
