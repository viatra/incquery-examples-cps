 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.incquery.examples.cps.cyberPhysicalSystem.impl.RequirementImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.eclipse.incquery.examples.cps.cyberPhysicalSystem.impl.RequirementImpl#getCount <em>Count</em>}</li>
 *   <li>{@link org.eclipse.incquery.examples.cps.cyberPhysicalSystem.impl.RequirementImpl#getRequest <em>Request</em>}</li>
 *   <li>{@link org.eclipse.incquery.examples.cps.cyberPhysicalSystem.impl.RequirementImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.eclipse.incquery.examples.cps.cyberPhysicalSystem.impl.RequirementImpl#getApplications <em>Applications</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequirementImpl extends MinimalEObjectImpl.Container implements Requirement {
	...
	public void setCount(int newCount) {
        ...
        count = newCount;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CyberPhysicalSystemPackage.REQUIREMENT__COUNT, oldCount, count));
    }
	...
	public NotificationChain basicSetRequest(Request newRequest, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject)newRequest, CyberPhysicalSystemPackage.REQUIREMENT__REQUEST, msgs);
        return msgs;
    }
	...
	public void setRequest(Request newRequest) {
        if (newRequest != eInternalContainer() || (eContainerFeatureID() != CyberPhysicalSystemPackage.REQUIREMENT__REQUEST && newRequest != null)) {
            ...
            if (newRequest != null)
                msgs = ((InternalEObject)newRequest).eInverseAdd(this, CyberPhysicalSystemPackage.REQUEST__REQUIREMENTS, Request.class, msgs);
            msgs = basicSetRequest(newRequest, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CyberPhysicalSystemPackage.REQUIREMENT__REQUEST, newRequest, newRequest));
    }
	...
	public ApplicationType getType() {
        if (type != null && type.eIsProxy()) {
            ...
            if (type != oldType) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, CyberPhysicalSystemPackage.REQUIREMENT__TYPE, oldType, type));
            }
        }
        return type;
    }
	...
	public EList<ApplicationInstance> getApplications() {
        if (applications == null) {
            applications = new EObjectResolvingEList<ApplicationInstance>(ApplicationInstance.class, this, CyberPhysicalSystemPackage.REQUIREMENT__APPLICATIONS);
        }
        return applications;
    }
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        switch (eContainerFeatureID()) {
            case CyberPhysicalSystemPackage.REQUIREMENT__REQUEST:
                return eInternalContainer().eInverseRemove(this, CyberPhysicalSystemPackage.REQUEST__REQUIREMENTS, Request.class, msgs);
        }
