 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.viatra.examples.cps.deployment.impl.DeploymentApplicationImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.viatra.examples.cps.deployment.impl.DeploymentApplicationImpl#getBehavior <em>Behavior</em>}</li>
 *   <li>{@link org.eclipse.viatra.examples.cps.deployment.impl.DeploymentApplicationImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeploymentApplicationImpl extends MinimalEObjectImpl.Container implements DeploymentApplication {
	/**
	 ...
	 * @generated
	 */
	protected DeploymentApplicationImpl() {
		super();
	}
	...
	public void setBehavior(DeploymentBehavior newBehavior) {
		if (newBehavior != behavior) {
			...
			if (behavior != null)
				msgs = ((InternalEObject)behavior).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DeploymentPackage.DEPLOYMENT_APPLICATION__BEHAVIOR, null, msgs);
			if (newBehavior != null)
				msgs = ((InternalEObject)newBehavior).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DeploymentPackage.DEPLOYMENT_APPLICATION__BEHAVIOR, null, msgs);
