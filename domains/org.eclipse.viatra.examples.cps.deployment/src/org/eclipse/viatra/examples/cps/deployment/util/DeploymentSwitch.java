...
public class DeploymentSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DeploymentPackage.DEPLOYMENT_HOST: {
				DeploymentHost deploymentHost = (DeploymentHost)theEObject;
				T result = caseDeploymentHost(deploymentHost);
				if (result == null) result = caseDeploymentElement(deploymentHost);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DeploymentPackage.DEPLOYMENT_APPLICATION: {
				DeploymentApplication deploymentApplication = (DeploymentApplication)theEObject;
				T result = caseDeploymentApplication(deploymentApplication);
				if (result == null) result = caseDeploymentElement(deploymentApplication);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DeploymentPackage.DEPLOYMENT_BEHAVIOR: {
				DeploymentBehavior deploymentBehavior = (DeploymentBehavior)theEObject;
				T result = caseDeploymentBehavior(deploymentBehavior);
				if (result == null) result = caseDeploymentElement(deploymentBehavior);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DeploymentPackage.BEHAVIOR_STATE: {
				BehaviorState behaviorState = (BehaviorState)theEObject;
				T result = caseBehaviorState(behaviorState);
				if (result == null) result = caseDeploymentElement(behaviorState);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DeploymentPackage.BEHAVIOR_TRANSITION: {
				BehaviorTransition behaviorTransition = (BehaviorTransition)theEObject;
				T result = caseBehaviorTransition(behaviorTransition);
				if (result == null) result = caseDeploymentElement(behaviorTransition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseDeploymentHost(DeploymentHost object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseDeploymentApplication(DeploymentApplication object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseDeploymentBehavior(DeploymentBehavior object) {
		return null;
	}
