...
/**
 * This is the item provider adapter for a {@link org.eclipse.incquery.examples.cps.model.StateMachine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addInitialPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StateMachine_initial_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StateMachine_initial_feature", "_UI_StateMachine_type"),
				 ModelPackage.Literals.STATE_MACHINE__INITIAL,
				 true,
				 false,
				 true,
				 null,
