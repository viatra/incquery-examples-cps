...
/**
 * This is the item provider adapter for a {@link org.eclipse.incquery.examples.cps.model.CyberPhysicalSystem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CyberPhysicalSystemItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.CYBER_PHYSICAL_SYSTEM__DB_URL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.CYBER_PHYSICAL_SYSTEM__APP_TYPES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.CYBER_PHYSICAL_SYSTEM__REQUESTS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.CYBER_PHYSICAL_SYSTEM__HOST_TYPES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.CYBER_PHYSICAL_SYSTEM__HOST_INSTANCES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.CYBER_PHYSICAL_SYSTEM__APP_INSTANCES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.CYBER_PHYSICAL_SYSTEM__APP_TYPES);
			childrenFeatures.add(ModelPackage.Literals.CYBER_PHYSICAL_SYSTEM__REQUESTS);
			childrenFeatures.add(ModelPackage.Literals.CYBER_PHYSICAL_SYSTEM__HOST_TYPES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.CYBER_PHYSICAL_SYSTEM__APP_TYPES,
				 ModelFactory.eINSTANCE.createApplicationType()));

		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.CYBER_PHYSICAL_SYSTEM__REQUESTS,
				 ModelFactory.eINSTANCE.createRequest()));

		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.CYBER_PHYSICAL_SYSTEM__HOST_TYPES,
				 ModelFactory.eINSTANCE.createHostType()));
	}
