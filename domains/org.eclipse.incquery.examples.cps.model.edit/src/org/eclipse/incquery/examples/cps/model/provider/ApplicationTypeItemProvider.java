/**
 */
package org.eclipse.incquery.examples.cps.model.provider;


import org.eclipse.incquery.examples.cps.model.ApplicationType;
import org.eclipse.incquery.examples.cps.model.ModelFactory;
...
/**
 * This is the item provider adapter for a {@link org.eclipse.incquery.examples.cps.model.ApplicationType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ApplicationTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.IDENTIFIABLE__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.APPLICATION_TYPE__EXE_FILE_LOCATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.APPLICATION_TYPE__EXE_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.APPLICATION_TYPE__ZIP_FILE_URL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.APPLICATION_TYPE__REQUIREMENTS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.APPLICATION_TYPE__CPS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.APPLICATION_TYPE__INSTANCES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.APPLICATION_TYPE__REQUIREMENTS);
			childrenFeatures.add(ModelPackage.Literals.APPLICATION_TYPE__INSTANCES);
			childrenFeatures.add(ModelPackage.Literals.APPLICATION_TYPE__BEHAVIOR);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.APPLICATION_TYPE__REQUIREMENTS,
				 ModelFactory.eINSTANCE.createResourceRequirement()));

		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.APPLICATION_TYPE__INSTANCES,
				 ModelFactory.eINSTANCE.createApplicationInstance()));

		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.APPLICATION_TYPE__BEHAVIOR,
