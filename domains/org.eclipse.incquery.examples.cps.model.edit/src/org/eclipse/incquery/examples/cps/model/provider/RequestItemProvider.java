...
/**
 * This is the item provider adapter for a {@link org.eclipse.incquery.examples.cps.model.Request} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RequestItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Request_requirements_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Request_requirements_feature", "_UI_Request_type"),
				 ModelPackage.Literals.REQUEST__REQUIREMENTS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.REQUEST__REQUIREMENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Request.class)) {
			case ModelPackage.REQUEST__REQUIREMENTS:
