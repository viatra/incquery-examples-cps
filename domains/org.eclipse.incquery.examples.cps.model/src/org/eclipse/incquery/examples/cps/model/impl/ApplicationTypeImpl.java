...
import org.eclipse.incquery.examples.cps.model.StateMachine;
 ...
 * <ul>
 *   <li>{@link org.eclipse.incquery.examples.cps.model.impl.ApplicationTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.eclipse.incquery.examples.cps.model.impl.ApplicationTypeImpl#getExeFileLocation <em>Exe File Location</em>}</li>
 *   <li>{@link org.eclipse.incquery.examples.cps.model.impl.ApplicationTypeImpl#getExeType <em>Exe Type</em>}</li>
 *   <li>{@link org.eclipse.incquery.examples.cps.model.impl.ApplicationTypeImpl#getZipFileUrl <em>Zip File Url</em>}</li>
 *   <li>{@link org.eclipse.incquery.examples.cps.model.impl.ApplicationTypeImpl#getRequirements <em>Requirements</em>}</li>
 *   <li>{@link org.eclipse.incquery.examples.cps.model.impl.ApplicationTypeImpl#getCps <em>Cps</em>}</li>
 *   <li>{@link org.eclipse.incquery.examples.cps.model.impl.ApplicationTypeImpl#getInstances <em>Instances</em>}</li>
 *   <li>{@link org.eclipse.incquery.examples.cps.model.impl.ApplicationTypeImpl#getBehavior <em>Behavior</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ApplicationTypeImpl extends MinimalEObjectImpl.Container implements ApplicationType {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.APPLICATION_TYPE;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.APPLICATION_TYPE__ID, oldId, id));
	}
	...
	public void setExeFileLocation(String newExeFileLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.APPLICATION_TYPE__EXE_FILE_LOCATION, oldExeFileLocation, exeFileLocation));
	}
	...
	public void setExeType(String newExeType) {
		...
		exeType = newExeType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.APPLICATION_TYPE__EXE_TYPE, oldExeType, exeType));
	}
	...
	public void setZipFileUrl(String newZipFileUrl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.APPLICATION_TYPE__ZIP_FILE_URL, oldZipFileUrl, zipFileUrl));
	}
	...
	public EList<ResourceRequirement> getRequirements() {
		if (requirements == null) {
			requirements = new EObjectContainmentEList<ResourceRequirement>(ResourceRequirement.class, this, ModelPackage.APPLICATION_TYPE__REQUIREMENTS);
		}
		return requirements;
	}
	...
	public CyberPhysicalSystem getCps() {
		if (eContainerFeatureID() != ModelPackage.APPLICATION_TYPE__CPS) return null;
	...
	public NotificationChain basicSetCps(CyberPhysicalSystem newCps, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newCps, ModelPackage.APPLICATION_TYPE__CPS, msgs);
		return msgs;
	}
	...
	public void setCps(CyberPhysicalSystem newCps) {
		if (newCps != eInternalContainer() || (eContainerFeatureID() != ModelPackage.APPLICATION_TYPE__CPS && newCps != null)) {
			...
			if (newCps != null)
				msgs = ((InternalEObject)newCps).eInverseAdd(this, ModelPackage.CYBER_PHYSICAL_SYSTEM__APP_TYPES, CyberPhysicalSystem.class, msgs);
			msgs = basicSetCps(newCps, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.APPLICATION_TYPE__CPS, newCps, newCps));
	}
	...
	public EList<ApplicationInstance> getInstances() {
		if (instances == null) {
			instances = new EObjectContainmentWithInverseEList<ApplicationInstance>(ApplicationInstance.class, this, ModelPackage.APPLICATION_TYPE__INSTANCES, ModelPackage.APPLICATION_INSTANCE__TYPE);
		}
		return instances;
	}
	...
	public NotificationChain basicSetBehavior(StateMachine newBehavior, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.APPLICATION_TYPE__BEHAVIOR, oldBehavior, newBehavior);
	...
	public void setBehavior(StateMachine newBehavior) {
		if (newBehavior != behavior) {
			NotificationChain msgs = null;
			if (behavior != null)
				msgs = ((InternalEObject)behavior).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.APPLICATION_TYPE__BEHAVIOR, null, msgs);
			if (newBehavior != null)
				msgs = ((InternalEObject)newBehavior).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.APPLICATION_TYPE__BEHAVIOR, null, msgs);
			msgs = basicSetBehavior(newBehavior, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.APPLICATION_TYPE__BEHAVIOR, newBehavior, newBehavior));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.APPLICATION_TYPE__CPS:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetCps((CyberPhysicalSystem)otherEnd, msgs);
			case ModelPackage.APPLICATION_TYPE__INSTANCES:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.APPLICATION_TYPE__REQUIREMENTS:
				return ((InternalEList<?>)getRequirements()).basicRemove(otherEnd, msgs);
			case ModelPackage.APPLICATION_TYPE__CPS:
				return basicSetCps(null, msgs);
			case ModelPackage.APPLICATION_TYPE__INSTANCES:
				return ((InternalEList<?>)getInstances()).basicRemove(otherEnd, msgs);
			case ModelPackage.APPLICATION_TYPE__BEHAVIOR:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ModelPackage.APPLICATION_TYPE__CPS:
				return eInternalContainer().eInverseRemove(this, ModelPackage.CYBER_PHYSICAL_SYSTEM__APP_TYPES, CyberPhysicalSystem.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.APPLICATION_TYPE__ID:
				return getId();
			case ModelPackage.APPLICATION_TYPE__EXE_FILE_LOCATION:
				return getExeFileLocation();
			case ModelPackage.APPLICATION_TYPE__EXE_TYPE:
				return getExeType();
			case ModelPackage.APPLICATION_TYPE__ZIP_FILE_URL:
