...
public class CyberPhysicalSystemSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case CyberPhysicalSystemPackage.IDENTIFIABLE: {
                Identifiable identifiable = (Identifiable)theEObject;
                T result = caseIdentifiable(identifiable);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case CyberPhysicalSystemPackage.CYBER_PHYSICAL_SYSTEM: {
                ...
                if (result == null) result = caseIdentifiable(cyberPhysicalSystem);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case CyberPhysicalSystemPackage.APPLICATION_TYPE: {
                ApplicationType applicationType = (ApplicationType)theEObject;
                T result = caseApplicationType(applicationType);
                if (result == null) result = caseIdentifiable(applicationType);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case CyberPhysicalSystemPackage.HOST_TYPE: {
                HostType hostType = (HostType)theEObject;
                T result = caseHostType(hostType);
                if (result == null) result = caseIdentifiable(hostType);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            ...
            case CyberPhysicalSystemPackage.HOST_INSTANCE: {
                HostInstance hostInstance = (HostInstance)theEObject;
                T result = caseHostInstance(hostInstance);
                if (result == null) result = caseIdentifiable(hostInstance);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case CyberPhysicalSystemPackage.APPLICATION_INSTANCE: {
                ...
                if (result == null) result = caseIdentifiable(applicationInstance);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            ...
            case CyberPhysicalSystemPackage.STATE_MACHINE: {
            ...
            case CyberPhysicalSystemPackage.STATE: {
            ...
            case CyberPhysicalSystemPackage.TRANSITION: {
	...
	/**
     * Returns the result of interpreting the object as an instance of '<em>Host Instance</em>'.
     * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Host Instance</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
	...
	/**
     * Returns the result of interpreting the object as an instance of '<em>Application Instance</em>'.
     * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Application Instance</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
