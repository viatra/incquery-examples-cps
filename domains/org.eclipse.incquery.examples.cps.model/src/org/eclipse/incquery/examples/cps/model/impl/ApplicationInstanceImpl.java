...
import org.eclipse.incquery.examples.cps.model.AppState;
 ...
 * <ul>
 *   <li>{@link org.eclipse.incquery.examples.cps.model.impl.ApplicationInstanceImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.eclipse.incquery.examples.cps.model.impl.ApplicationInstanceImpl#getState <em>State</em>}</li>
 *   <li>{@link org.eclipse.incquery.examples.cps.model.impl.ApplicationInstanceImpl#getDbUser <em>Db User</em>}</li>
 *   <li>{@link org.eclipse.incquery.examples.cps.model.impl.ApplicationInstanceImpl#getDbPassword <em>Db Password</em>}</li>
 *   <li>{@link org.eclipse.incquery.examples.cps.model.impl.ApplicationInstanceImpl#getAllocatedTo <em>Allocated To</em>}</li>
 *   <li>{@link org.eclipse.incquery.examples.cps.model.impl.ApplicationInstanceImpl#getDependOn <em>Depend On</em>}</li>
 *   <li>{@link org.eclipse.incquery.examples.cps.model.impl.ApplicationInstanceImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ApplicationInstanceImpl extends MinimalEObjectImpl.Container implements ApplicationInstance {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.APPLICATION_INSTANCE;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.APPLICATION_INSTANCE__ID, oldId, id));
	}
	...
	public void setState(AppState newState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.APPLICATION_INSTANCE__STATE, oldState, state));
	}
	...
	public void setDbUser(String newDbUser) {
		...
		dbUser = newDbUser;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.APPLICATION_INSTANCE__DB_USER, oldDbUser, dbUser));
	}
	...
	public void setDbPassword(String newDbPassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.APPLICATION_INSTANCE__DB_PASSWORD, oldDbPassword, dbPassword));
	}
	...
	public HostInstance getAllocatedTo() {
		if (allocatedTo != null && allocatedTo.eIsProxy()) {
			...
			if (allocatedTo != oldAllocatedTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.APPLICATION_INSTANCE__ALLOCATED_TO, oldAllocatedTo, allocatedTo));
			}
		}
		return allocatedTo;
	}
	...
	public NotificationChain basicSetAllocatedTo(HostInstance newAllocatedTo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.APPLICATION_INSTANCE__ALLOCATED_TO, oldAllocatedTo, newAllocatedTo);
	...
	public void setAllocatedTo(HostInstance newAllocatedTo) {
		if (newAllocatedTo != allocatedTo) {
			...
			if (allocatedTo != null)
				msgs = ((InternalEObject)allocatedTo).eInverseRemove(this, ModelPackage.HOST_INSTANCE__APPLICATIONS, HostInstance.class, msgs);
			if (newAllocatedTo != null)
				msgs = ((InternalEObject)newAllocatedTo).eInverseAdd(this, ModelPackage.HOST_INSTANCE__APPLICATIONS, HostInstance.class, msgs);
			msgs = basicSetAllocatedTo(newAllocatedTo, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.APPLICATION_INSTANCE__ALLOCATED_TO, newAllocatedTo, newAllocatedTo));
	}
	...
	public EList<ApplicationInstance> getDependOn() {
		if (dependOn == null) {
			dependOn = new EObjectResolvingEList<ApplicationInstance>(ApplicationInstance.class, this, ModelPackage.APPLICATION_INSTANCE__DEPEND_ON);
		}
		return dependOn;
	}
	...
	public ApplicationType getType() {
		if (eContainerFeatureID() != ModelPackage.APPLICATION_INSTANCE__TYPE) return null;
	...
	public NotificationChain basicSetType(ApplicationType newType, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newType, ModelPackage.APPLICATION_INSTANCE__TYPE, msgs);
		return msgs;
	}
	...
	public void setType(ApplicationType newType) {
		if (newType != eInternalContainer() || (eContainerFeatureID() != ModelPackage.APPLICATION_INSTANCE__TYPE && newType != null)) {
			...
			if (newType != null)
				msgs = ((InternalEObject)newType).eInverseAdd(this, ModelPackage.APPLICATION_TYPE__INSTANCES, ApplicationType.class, msgs);
			msgs = basicSetType(newType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.APPLICATION_INSTANCE__TYPE, newType, newType));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.APPLICATION_INSTANCE__ALLOCATED_TO:
				if (allocatedTo != null)
					msgs = ((InternalEObject)allocatedTo).eInverseRemove(this, ModelPackage.HOST_INSTANCE__APPLICATIONS, HostInstance.class, msgs);
				return basicSetAllocatedTo((HostInstance)otherEnd, msgs);
			case ModelPackage.APPLICATION_INSTANCE__TYPE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ModelPackage.APPLICATION_INSTANCE__TYPE:
				return eInternalContainer().eInverseRemove(this, ModelPackage.APPLICATION_TYPE__INSTANCES, ApplicationType.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.APPLICATION_INSTANCE__ID:
				return getId();
			case ModelPackage.APPLICATION_INSTANCE__STATE:
				return getState();
			case ModelPackage.APPLICATION_INSTANCE__DB_USER:
				return getDbUser();
			case ModelPackage.APPLICATION_INSTANCE__DB_PASSWORD:
				return getDbPassword();
			case ModelPackage.APPLICATION_INSTANCE__ALLOCATED_TO:
				if (resolve) return getAllocatedTo();
				return basicGetAllocatedTo();
			case ModelPackage.APPLICATION_INSTANCE__DEPEND_ON:
				return getDependOn();
			case ModelPackage.APPLICATION_INSTANCE__TYPE:
				return getType();
		}
