...
public class ModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModelPackage.CYBER_PHYSICAL_SYSTEM: {
			...
			case ModelPackage.APPLICATION_TYPE: {
			...
			case ModelPackage.RESOURCE_REQUIREMENT: {
			...
			case ModelPackage.HOST_INSTANCE: {
			...
			case ModelPackage.APPLICATION_INSTANCE: {
