...
public class TraceabilitySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TraceabilityPackage.CPS_TO_DEPLOYMENT: {
				CPSToDeployment cpsToDeployment = (CPSToDeployment)theEObject;
				T result = caseCPSToDeployment(cpsToDeployment);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>CPS To Deployment</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>CPS To Deployment</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCPSToDeployment(CPSToDeployment object) {
		return null;
	}
