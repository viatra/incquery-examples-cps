...
public class TraceabilityAdapterFactory extends AdapterFactoryImpl {
	...
	protected TraceabilitySwitch<Adapter> modelSwitch =
		new TraceabilitySwitch<Adapter>() {
			@Override
			public Adapter caseCPSToDeployment(CPSToDeployment object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.viatra.examples.cps.traceability.CPSToDeployment <em>CPS To Deployment</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCPSToDeploymentAdapter() {
		return null;
	}
