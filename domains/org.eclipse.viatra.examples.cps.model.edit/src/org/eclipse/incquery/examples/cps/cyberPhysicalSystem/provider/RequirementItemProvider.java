...
/**
 * This is the item provider adapter for a {@link org.eclipse.incquery.examples.cps.cyberPhysicalSystem.Requirement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addCountPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Requirement_count_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Requirement_count_feature", "_UI_Requirement_type"),
                 CyberPhysicalSystemPackage.Literals.REQUIREMENT__COUNT,
                 true,
                 false,
                 false,
	...
	protected void addRequestPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Requirement_request_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Requirement_request_feature", "_UI_Requirement_type"),
                 CyberPhysicalSystemPackage.Literals.REQUIREMENT__REQUEST,
                 true,
                 false,
                 true,
                 null,
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 CyberPhysicalSystemPackage.Literals.REQUIREMENT__TYPE,
                 true,
                 false,
                 true,
                 null,
	...
	protected void addApplicationsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Requirement_applications_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Requirement_applications_feature", "_UI_Requirement_type"),
                 CyberPhysicalSystemPackage.Literals.REQUIREMENT__APPLICATIONS,
                 true,
                 false,
                 true,
                 null,
