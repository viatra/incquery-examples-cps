package org.eclipse.incquery.examples.cps.xform.m2m.incr.viatra.rules
...
import org.eclipse.incquery.examples.cps.xform.m2m.incr.viatra.patterns.ApplicationInstanceMatcher
import org.eclipse.incquery.examples.cps.xform.m2m.incr.viatra.patterns.CpsXformM2M
import org.eclipse.incquery.examples.cps.xform.m2m.incr.viatra.patterns.HostInstanceMatcher
import org.eclipse.incquery.examples.cps.xform.m2m.incr.viatra.patterns.StateMachineMatcher
	...
	public def getApplicationRule() {
		if (applicationRule == null) {
			...
			applicationRule = createRule.precondition(ApplicationInstanceMatcher.querySpecification).action(
				...
				val trace = engine.cps2depTrace.getAllValuesOftrace(null, appInstance, null).filter(
					org.eclipse.incquery.examples.cps.traceability.CPS2DeplyomentTrace).head
