...
/**
 * Pattern-specific match representation of the org.eclipse.incquery.examples.cps.xform.m2t.monitor.hostApplicationsChange pattern,
 * to be used in conjunction with {@link HostApplicationsChangeMatcher}.
 * 
...
public abstract class HostApplicationsChangeMatch extends BasePatternMatch {
  private DeploymentHost fDeploymentHost;
  
  private static List<String> parameterNames = makeImmutableList("deploymentHost");
  
  private HostApplicationsChangeMatch(final DeploymentHost pDeploymentHost) {
  ...
  public List<String> parameterNames() {
    return HostApplicationsChangeMatch.parameterNames;
  }
  ...
  @Override
  public HostApplicationsChangeMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof HostApplicationsChangeMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    HostApplicationsChangeMatch other = (HostApplicationsChangeMatch) obj;
  ...
  @Override
  public HostApplicationsChangeQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static HostApplicationsChangeMatch newEmptyMatch() {
   ...
   * 
   */
  public static HostApplicationsChangeMatch newMutableMatch(final DeploymentHost pDeploymentHost) {
   ...
   * 
   */
  public static HostApplicationsChangeMatch newMatch(final DeploymentHost pDeploymentHost) {
    return new Immutable(pDeploymentHost);
  }
  
  private static final class Mutable extends HostApplicationsChangeMatch {
  ...
  private static final class Immutable extends HostApplicationsChangeMatch {
